...
class _AttendanceScreenState extends State<AttendanceScreen>
  ...
  // Session ended overlay (shown when WS notifies, not API response)
  bool _showSessionEndedOverlay = false;
  ...
  void _connectWebSocket() {
    ...
    _wsSessionEndedSubscription = _wsService.onSessionEnded.listen((event) {
      ...
      setState(() => _showSessionEndedOverlay = true);
    });
  }
  ...
  Widget _buildSessionEndedOverlay(bool isDark) {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() => _showSessionEndedOverlay = false);
                  _navigateToSummary();
                },
                style: ElevatedButton.styleFrom(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            if (_showSessionEndedOverlay) _buildSessionEndedOverlay(isDark),
          ],
        ),
      ),
    );
