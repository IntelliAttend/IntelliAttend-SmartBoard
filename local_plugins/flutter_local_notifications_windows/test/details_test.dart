...
void main() => group('Details:', () {
  ...
  test(
    ...
    () async => plugin
      ...
      ..testDetails(const WindowsNotificationDetails(subtitle: 'Subtitle'))
      ..testDetails(
  ...
  test('Actions', () {
    const WindowsAction simpleAction = WindowsAction(
      content: 'Press me',
      arguments: '123',
    );
    ...
    plugin
      ...
      ..testDetails(
        WindowsNotificationDetails(actions: <WindowsAction>[complexAction]),
      )
      ..testDetails(
  ...
  test('Rows', () {
    const WindowsColumn emptyColumn = WindowsColumn(
    ...
    const WindowsNotificationText text = WindowsNotificationText(text: 'Text');
    final WindowsColumn simpleColumn = WindowsColumn(<WindowsNotificationPart>[
      image,
      text,
    ]);
  ...
  test('Inputs', () async {
    ...
    plugin
      ..testDetails(
        const WindowsNotificationDetails(inputs: <WindowsInput>[textInput]),
      )
      ..testDetails(
        const WindowsNotificationDetails(inputs: <WindowsInput>[selection]),
      )
      ..testDetails(
        WindowsNotificationDetails(
  ...
  test('Progress', () async {
    ...
    for (double i = 0; i <= 1.5; i += 0.05) {
      dynamic.value = i;
      final NotificationUpdateResult result = await plugin.updateProgressBar(
        notificationId: 201,
        progressBar: dynamic,
      );
    ...
    expect(
      await plugin.updateProgressBar(notificationId: 202, progressBar: dynamic),
