  ...
  Widget _buildIdleView() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 24),
        Text('No Active Schedule', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
        SizedBox(height: 8),
        Text('The board will automatically wake up when the next class is scheduled.', 
